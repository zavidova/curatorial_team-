...
This code has been downloaded from : www.WatchOutOnNet.com

If you liked it or benefitted from it, please subscribe to our
...
// Text to display
 // before all hits.
 $beforeAllText = "<span style='display:none'>Total Hits: ";
 
// Before unique hits.
 $beforeUniqueText = "Dear Visitor Nr.";
